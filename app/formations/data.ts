...
export const formations: Formation[] = [
  ...
  },
  {
      ...
      description: "Apprenez à nourrir la peau de l'intérieur pour l'éclat, la détoxification et le bien-être.",
      summary: "Des recettes simples et naturelles à base de fruits et légumes pour soutenir un mode de vie plus léger, éclatant et équilibré.",
      goals: [
          "Comprendre les bienfaits des fruits et légumes pour la peau",
          "Découvrir des recettes detox simples et efficaces",
          "Créer une routine saine et durable",
          "Améliorer le bien-être global au quotidien",
      ],
      format: [
          "Conseils nutritionnels concrets",
          "Recettes detox faciles à reproduire",
