...
const CALENDLY_URL = "https://calendly.com/essentielle-formation-bien-etre/45min";
...
const cardDescStyle: CSSProperties = { fontSize: "12.5px", lineHeight: 1.6, color: "#6B6455", margin: "0 0 16px" };
